...
/* La funcion Lectura se utliza para leer un arreglo bidimensional de tipo
...
/* Esta funcion se utiliza tanto para obtener el promedio de cada examen,
como tambien el examen que obtuvo el promedio mas alto. */
{
  ...
  printf("\n\nEl examen con mayor promedio es: %5.2f", MAY+1, MPRO);
}
