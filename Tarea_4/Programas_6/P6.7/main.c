...
de los productos. Observa que el resultado se almacena en in arreglo
unidimensional que se utlizara posteriormente. */
{
    int I, J, SUM;
    printf("\n");
    for (I=0; I< F; I++)
...
/* Esta funcion se utiliza para calcular el monto total de ventas
de la fabrica. */
int I;
float SUM = 0.0;
for (I=0; I<C; I++)
