...
void main(void)
{
    ...
    strcpy(cad1, cad3);
    printf("\nPrueba de la funcion strcpy. Se copia la cadena cad1 a cad1: %s\n", cad1);
    ...
    strcat(cad0, cad3);
    printf("\nPrueba de la funcion strcat. Se incorpora la cadena de cad3 a cad0: %s\n", cad0);

    strcat(cad1, " YY");
    printf("\nPrueba de la funcion strcat. Se incorpora la cadena de YY a cad1: %s\n", cad1);
