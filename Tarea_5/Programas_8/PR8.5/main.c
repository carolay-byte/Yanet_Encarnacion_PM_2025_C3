...
/* Esta funcion se utliza para incrementar 5% el salario de todos aquellos
vendedores cuyas ventas anueles superaron $1,500,000. */
{
    int I, J;
    float SUM;
    ...
    /* Esta funcion se usa para imprimir el numero de empleado, el nombre del banco
    y el numero de cuenta de todos aquellos empleados a quienes se les
